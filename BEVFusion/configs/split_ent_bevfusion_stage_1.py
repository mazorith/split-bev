...
model = dict(
    ...
    image_encoder= dict(
        type="SplitImageEncoder",
        in_channels=3,
        out_channels=256),
    # lidar_encoder= dict(
    #     type="SplitLidarEncoder", 
    #     final_feature_size=66, 
    #     target_input_size=[0,5], 
    #     out_channels=66),
    #'''second version lidar encoder'''
    lidar_encoder= dict(
        type='BEVFusionSparseEncoder',
        in_channels=5,
        sparse_shape=[1440, 1440, 41],
        ...
        block_type='basicblock'),
    fuser_neck= dict(
        type="FuserNeck_entro",
        in_channels=132, 
        mid_channels=45, 
        out_channels=45),
    fuser_decoder= dict(
        type="FuserDecoder_entro",
        in_channels=132, 
        mid_channels=45, 
        out_channels=45),
    use_entropy = 0
